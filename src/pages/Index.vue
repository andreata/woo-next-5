  ...
  <Layout>
    <div>
      <div class="full-container bg-home">
        <div class="container">
          <h1 class="title-home desk">eCommerce di tecnologia aliena</h1>
          <p class="p-home desk">Lume di Luna è un template (<span class="underline">esattamente quello che stai guardando</span>), in grado di rendere il tuo sito o eCommerce WordPress una vera <strong>potenza</strong>.</p>

          <div class="mobl">
            <div class="home-layout-mobile">
              <div>
                <h1 class="title-home-mobile mobl">eCommerce di tecnologia aliena</h1>
                <p class="p-home-mobile mobl">Il tuo nuovo eCommerce ultra-veloce e sicuro.</p>
              </div>
          ...
          <div class="container-box desk">
            <div class="item-box">
              <p class="promo">Servizio</p>
              <g-image class="img-promo" src="~/assets/images/icon/icon1.svg" alt="" width="100" />
              <h2 class="h2-promo">eCommerce Standard</h2>
              <h3 class="h3-promo">1500€/anno + spese di hosting</h3>
              <p class="li-promo"><svg xmlns="http://www.w3.org/2000/svg" width="17.001" height="16.999"
                ...
                </svg> <span>Logo e colori personalizzabili</span></p>
              ...
              <p class="li-promo"><svg xmlns="http://www.w3.org/2000/svg" width="17.001" height="16.999"
                  ...
                  <path id="Tracciato_760" data-name="Tracciato 760"
                    d="M8.5,17c-.087,0-.175,0-.262,0A8.5,8.5,0,0,1,7.716.034C7.967.012,8.223,0,8.475,0a8.524,8.524,0,0,1,8.491,9.283A8.5,8.5,0,0,1,8.5,17ZM4.49,7.343a.806.806,0,0,0-.225.032A.811.811,0,0,0,3.929,8.74L6.9,11.575a.81.81,0,0,0,1.129,0L13.066,6.59h.005a.809.809,0,0,0-1.138-1.151L7.449,9.869l-2.4-2.3A.808.808,0,0,0,4.49,7.343Z"
                    transform="translate(0 0)" fill="#f9b666" />
                </svg> <span>Aggiornamenti inclusi</span></p>
              ...
              <p class="li-promo"><svg xmlns="http://www.w3.org/2000/svg" width="17.001" height="16.999"
                  ...
                  <path id="Tracciato_760" data-name="Tracciato 760"
                    d="M8.5,17c-.087,0-.175,0-.262,0A8.5,8.5,0,0,1,7.716.034C7.967.012,8.223,0,8.475,0a8.524,8.524,0,0,1,8.491,9.283A8.5,8.5,0,0,1,8.5,17ZM4.49,7.343a.806.806,0,0,0-.225.032A.811.811,0,0,0,3.929,8.74L6.9,11.575a.81.81,0,0,0,1.129,0L13.066,6.59h.005a.809.809,0,0,0-1.138-1.151L7.449,9.869l-2.4-2.3A.808.808,0,0,0,4.49,7.343Z"
                    transform="translate(0 0)" fill="#f9b666" />
                </svg> <span>Assistenza tecnica con sistema ticketing</span></p>
              ...
              <p class="li-promo"><svg xmlns="http://www.w3.org/2000/svg" width="17.001" height="16.999"
                  ...
                  <path id="Tracciato_760" data-name="Tracciato 760"
                    d="M8.5,17c-.087,0-.175,0-.262,0A8.5,8.5,0,0,1,7.716.034C7.967.012,8.223,0,8.475,0a8.524,8.524,0,0,1,8.491,9.283A8.5,8.5,0,0,1,8.5,17ZM4.49,7.343a.806.806,0,0,0-.225.032A.811.811,0,0,0,3.929,8.74L6.9,11.575a.81.81,0,0,0,1.129,0L13.066,6.59h.005a.809.809,0,0,0-1.138-1.151L7.449,9.869l-2.4-2.3A.808.808,0,0,0,4.49,7.343Z"
                    transform="translate(0 0)" fill="#f9b666" />
                </svg> <span>Configurazione e rilascio del sito</span></p>

              <g-link to="/home-landing/" class="button-pieno">Clicca e richiedi</g-link>

            </div>

            <div class="item-box">
              <p class="promo">Servizio Pro</p>
              <g-image class="img-promo" src="~/assets/images/icon/icon2.svg" alt="" width="100" />
              <h2 class="h2-promo">eCommerce Custom</h2>
              <h3 class="h3-promo">1500€/anno + costo customizzazioni</h3>
               <p class="li-promo"><svg xmlns="http://www.w3.org/2000/svg" width="17.001" height="16.999"
                  viewBox="0 0 17.001 16.999">
                  <path id="Tracciato_760" data-name="Tracciato 760"
                    d="M8.5,17c-.087,0-.175,0-.262,0A8.5,8.5,0,0,1,7.716.034C7.967.012,8.223,0,8.475,0a8.524,8.524,0,0,1,8.491,9.283A8.5,8.5,0,0,1,8.5,17ZM4.49,7.343a.806.806,0,0,0-.225.032A.811.811,0,0,0,3.929,8.74L6.9,11.575a.81.81,0,0,0,1.129,0L13.066,6.59h.005a.809.809,0,0,0-1.138-1.151L7.449,9.869l-2.4-2.3A.808.808,0,0,0,4.49,7.343Z"
                    transform="translate(0 0)" fill="#f9b666" />
                </svg> <span>Tutto ciò che è previsto nel piano base.</span></p>
              ...
              <p class="li-promo"><svg xmlns="http://www.w3.org/2000/svg" width="17.001" height="16.999"
                  ...
                  <path id="Tracciato_760" data-name="Tracciato 760"
                    d="M8.5,17c-.087,0-.175,0-.262,0A8.5,8.5,0,0,1,7.716.034C7.967.012,8.223,0,8.475,0a8.524,8.524,0,0,1,8.491,9.283A8.5,8.5,0,0,1,8.5,17ZM4.49,7.343a.806.806,0,0,0-.225.032A.811.811,0,0,0,3.929,8.74L6.9,11.575a.81.81,0,0,0,1.129,0L13.066,6.59h.005a.809.809,0,0,0-1.138-1.151L7.449,9.869l-2.4-2.3A.808.808,0,0,0,4.49,7.343Z"
                    transform="translate(0 0)" fill="#f9b666" />
                </svg> <span>Possibilità di personalizzare tutte le componenti del sito (50€/ora)</span></p>
              ...
              <p class="li-promo"><svg xmlns="http://www.w3.org/2000/svg" width="17.001" height="16.999"
                  ...
                  <path id="Tracciato_760" data-name="Tracciato 760"
                    d="M8.5,17c-.087,0-.175,0-.262,0A8.5,8.5,0,0,1,7.716.034C7.967.012,8.223,0,8.475,0a8.524,8.524,0,0,1,8.491,9.283A8.5,8.5,0,0,1,8.5,17ZM4.49,7.343a.806.806,0,0,0-.225.032A.811.811,0,0,0,3.929,8.74L6.9,11.575a.81.81,0,0,0,1.129,0L13.066,6.59h.005a.809.809,0,0,0-1.138-1.151L7.449,9.869l-2.4-2.3A.808.808,0,0,0,4.49,7.343Z"
                    transform="translate(0 0)" fill="#f9b666" />
                </svg> <span>Assistenza tecnica tramite mail (risposta rapida)</span></p>
            ...
            <div class="item-box">
              ...
              <g-image class="img-promo" src="~/assets/images/icon/icon4.svg" alt="" width="100" />
              <h2 class="h2-promo">Leggi il nostro blog</h2>
              <h3 class="h3-promo">Scopri le novità del blog</h3>
              <p class="li-promo"><svg xmlns="http://www.w3.org/2000/svg" width="17.001" height="16.999"
                  viewBox="0 0 17.001 16.999">
                  <path id="Tracciato_760" data-name="Tracciato 760"
                    d="M8.5,17c-.087,0-.175,0-.262,0A8.5,8.5,0,0,1,7.716.034C7.967.012,8.223,0,8.475,0a8.524,8.524,0,0,1,8.491,9.283A8.5,8.5,0,0,1,8.5,17ZM4.49,7.343a.806.806,0,0,0-.225.032A.811.811,0,0,0,3.929,8.74L6.9,11.575a.81.81,0,0,0,1.129,0L13.066,6.59h.005a.809.809,0,0,0-1.138-1.151L7.449,9.869l-2.4-2.3A.808.808,0,0,0,4.49,7.343Z"
                    transform="translate(0 0)" fill="#f9b666" />
                </svg> <span>Aggiornamenti su Lume di Luna</span></p>
              ...
              <p class="li-promo"><svg xmlns="http://www.w3.org/2000/svg" width="17.001" height="16.999"
                  ...
                  <path id="Tracciato_760" data-name="Tracciato 760"
                    d="M8.5,17c-.087,0-.175,0-.262,0A8.5,8.5,0,0,1,7.716.034C7.967.012,8.223,0,8.475,0a8.524,8.524,0,0,1,8.491,9.283A8.5,8.5,0,0,1,8.5,17ZM4.49,7.343a.806.806,0,0,0-.225.032A.811.811,0,0,0,3.929,8.74L6.9,11.575a.81.81,0,0,0,1.129,0L13.066,6.59h.005a.809.809,0,0,0-1.138-1.151L7.449,9.869l-2.4-2.3A.808.808,0,0,0,4.49,7.343Z"
                    transform="translate(0 0)" fill="#f9b666" />
                </svg> <span>Novità dal mondo Jamstack</span></p>
          ...
          <div class="container-box mobl">
            <g-link to="/home-landing/" class="link-no-deco">
              <div class="item-box">
                ...
                <div class="flex-homeland">
                  <g-image class="img-promo" src="~/assets/images/icon/icon1.svg" alt="" width="66" />
                  <div>
                    <h2 class="h2-promo">eCommerce Standard</h2>
                    <h3 class="h3-promo">1500€/anno</h3>
                  </div>
                </div>
            ...
            <g-link to="/home-landing/" class="link-no-deco">
              <div class="item-box">
                <p class="promo">Servizio PRO</p>
                <div class="flex-homeland">
                  <g-image class="img-promo" src="~/assets/images/icon/icon2.svg" alt="" width="66" />
                  <div>
                    <h2 class="h2-promo">eCommerce Custom</h2>
                    <h3 class="h3-promo">1500€/anno + costo customizzazioni</h3>
                  </div>
            ...
            <g-link to="/offertasuper_wordpress/categoria-prodotto/shop" class="link-no-deco">
              <div class="item-box">
                <p class="promo">Demo</p>
                <div class="flex-homeland">
                  <g-image class="img-promo" src="~/assets/images/icon/icon3.svg" alt="" width="66" />
                  <div>
                    <h2 class="h2-promo">Prova l'eCommerce</h2>
                    <h3 class="h3-promo">Naviga e scopri</h3>
                  </div>
                </div>
              </div>
            </g-link>
            ...
            <g-link to="/offertasuper_wordpress/category/blog/" class="link-no-deco">
              <div class="item-box">
                ...
                <div class="flex-homeland">
                  <g-image class="img-promo" src="~/assets/images/icon/icon4.svg" alt="" width="66" />
                  <div>
                    <h2 class="h2-promo">Le ultime dal blog</h2>
                    <h3 class="h3-promo">Notizie, guide, curiosità</h3>
                  </div>
                </div>
              </div>
            </g-link>
        ...
        <div class="container">
          <div class="grid-two-column">
            ...
            <div class="flex-content-copy">
              <div>
                <h2>WordPress + WooCommerce + Gridsome + SnipCart = navighi dalla luna!</h2>
                <p>Se conosci WordPress sai quanto possa essere funzionale, ma sei anche consapevoli dei limiti della sua velocità. 
                  
                </p>
                <p class="content-2">Noi abbiamo collegato l'ottima gestione CMS di WordPress e WooCommerce, con le prestazioni di un framework Javascript basato su Vue.js per ottenere prestazioni stellari.</p>

                <g-link to="/home-landing/" class="button-vuoto">Richiedi informazioni</g-link>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="">
          ...
          <ClientOnly>
            <carousel class="carousel" :perPageCustom="[[768, 2], [1024, 5]]" :paginationEnabled="true">
              ...
              <slide class="carousel-cell carousel-item-home" v-if="edge.node.regularPrice" v-for="(edge, index) in $page.products.edges" :key="edge.node.id">

                <div class="salmone-bg">
                  <h3>Prodotto di esempio</h3>
                  <p class="sal-1">{{ edge.node.name }}</p> 
                </div>
                  <g-image alt="Cover image" v-if="edge.node.image" class="sal-img" :src="edge.node.image.mediaItemUrl" /> 
      ...
      <div class="full-container">
        ...
        <div class="container recensioni">
          ...
          <h2 class="text-center mb-80">Le recensioni dei clienti che si sono affidati a noi</h2>
          <ClientOnly>
