  ...
  <Layout :sidebarproduct="true" class="side">
    ...
    <div>
        <div class="breadcrumbs">
            <ul>
                <li v-for="breadcrumb in $page.productTag.seo.breadcrumbs" :key="breadcrumb.text">
  ...
  <!--       
    ...
    <div data-role="rangeslider" class="rangeslider">
        ...
        <div class="content-category">
             ...
             <PostCardProductTag :post="edge.node" v-for="(edge, index) in productsFiltered" :key="edge.node.id"
          v-if="index >= 1" />
        </div>
          

      <!-- <li v-for="(edge, index) in $page.productTag.products.edges" :key="edge.node.id" v-if="index > 5">
...
query Categoryprod ($slug: ID!) {
  productTag(idType: SLUG, id: $slug) {
    name
    link
    seo {
        breadcrumbs {
...
import PostCardProductTag from '~/components/PostCardProductTag.vue'
...
export default {
  ...
  computed: {
      ...
      productsFiltered() {
          ...
          return this.$page.productTag.products.edges.filter(item => {  
